...
Pod::Spec.new do |spec|
  spec.name         = 'NETeamUIKitSwiftUI'
  spec.version      = YXConfig.imuikit_version
  spec.summary      = 'Netease XKit IM UIKit - SwiftUI Team Module'
  ...
  spec.source_files = 'NETeamUIKitSwiftUI/Classes/**/*'
  spec.resource = 'NETeamUIKitSwiftUI/Assets/**/*'
